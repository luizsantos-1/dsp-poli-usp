...
wavfile.write('Recovered_Que_maravilha_cut2.wav', sample_rate, np.asarray(x_est, dtype=np.int16))
wavfile.write('Distorted_Que_maravilha_cut2.wav', sample_rate, np.asarray(y, dtype=np.int16))
